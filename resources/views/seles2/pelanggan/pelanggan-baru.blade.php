...
@section('content')
    <div class="pelanggan-page">
        ...
        <div class="pelanggan-header d-flex align-items-center">
            ...
            <h5 class="mb-0 fw-bold">Pelanggan Baru</h5>
        </div>
        ...
        <div class="filter-tabs-container mt-3 px-3">
            <div class="filter-tabs d-flex gap-2 flex-nowrap overflow-auto pb-2">
                ...
                <a href="#" class="filter-tab">Belum Bayar</a>
                <a href="#" class="filter-tab">Sudah Bayar</a>
                <a href="#" class="filter-tab active">Baru</a>
                <a href="#" class="filter-tab">Berhenti</a>
            </div>
        </div>
                ...
                <div class="pelanggan-card mb-3">
                    <div class="d-flex align-items-center w-100">
                        ...
                        <div class="flex-grow-1">
                            <h6 class="fw-bold text-dark mb-0">Pelanggan Baru {{ $i }}</h6>
                        ...
                        {{-- Stretched Link (Agar bisa diklik seluruh kartu) --}}
